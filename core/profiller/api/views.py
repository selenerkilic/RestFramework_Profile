...
# Viewset+router ile yaptık ama burda update gibi metotlar,formlar gelmiyor. bunun için genercilerden yararlanıcaz.
...
#bu viewset olmadan önce yaptığımız. 
# class ProfilList(generics.ListAPIView):
#     queryset = Profil.objects.all()  #kullanıcılar birbirlerinin profillerini görüntüleyebiliyor.
#     serializer_class = ProfilSerializer
#     permission_classes = [IsAuthenticated] 